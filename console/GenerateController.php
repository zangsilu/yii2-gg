...
/**
 * This is the command line version of gg - a code generator.
 *
 ...
 *
 * ```
 * $ ./yii gg/model --tableName=city --modelClass=City
 * ```
 *
...
class GenerateController extends Controller
{
    ...
    public function actions()
    {
        ...
        foreach ($this->generators as $name => $generator) {
            $actions[$name] = [
                'class'     => 'yii\gg\console\GenerateAction',
                'generator' => $generator,
            ];
        }
