...
abstract class Generator extends Model
{
     ...
     * Please refer to [[\yii\gg\generators\controller\Generator::generate()]] as an example
    ...
    {
        return Yii::$app->getRuntimePath() . '/gg-' . Yii::getVersion() . '/' . str_replace('\\', '-',
                get_class($this)) . '.json';
    }
        ...
        try {
            if (class_exists($class)) {
                if (isset($params['extends'])) {
                    if (ltrim($class, '\\') !== ltrim($params['extends'], '\\') && !is_subclass_of($class,
                            $params['extends'])
                    ) {
